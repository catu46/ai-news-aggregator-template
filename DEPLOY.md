...
- A database on **Supabase Free** with `db/schema.sql` applied (SQL Editor).
- A GitHub repo — **private** (it carries your `config/sources.yaml`).
- A **Railway** account.
...
\* Without the X cookies, Twitter ingestion is disabled; Reddit/GitHub keep going.
